...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [1050975.165748, 5851955.306903, 1595619.345018, 6381019.737676], maxZoom: 16, minZoom: 9
    })
});


map.getView().fit([1050975.165748, 5851955.306903, 1595619.345018, 6381019.737676], map.getSize());
