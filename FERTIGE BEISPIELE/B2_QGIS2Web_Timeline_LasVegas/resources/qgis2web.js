...
var map = new ol.Map({
	...
	//Controls Vollbild und Maﬂstabsleiste
    ...
    layers: layersList,
    view: new ol.View({
        extent: [629430.547033, 3966668.173816, 704122.422109, 4040486.923892], maxZoom: 20, minZoom: 9, projection: new ol.proj.Projection({
            code: 'EPSG:32611',
...
map.getView().fit([629430.547033, 3966668.173816, 704122.422109, 4040486.923892], map.getSize());
