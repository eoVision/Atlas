...
//EUROPA Filter
function EuropaFilter() {
var decider = document.getElementById('EuropaFilter');
if(decider.checked){

  var searchQuery = "EUROPA";
  var dataSources = viewer.dataSources._dataSources;
  var treffer = [];
  console.log(dataSources);
  var i = 0;
...
//KLIMA Filter
function KlimaFilter() {
  var decider = document.getElementById('KlimaFilter');
  if(decider.checked){

    var searchQuery = "KLIMA";
    var dataSources = viewer.dataSources._dataSources;
    var treffer = [];
    console.log(dataSources);
    var i = 0;
