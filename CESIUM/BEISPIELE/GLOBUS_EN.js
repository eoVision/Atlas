...
polygons.then(function (dataSource){
  ...
  for (var i = 0; i < entities.length; i++){
    ...
    entity.description = "<p>"+ entity.properties.beschreibung +" <i>This description is automatically generated from the GeoJSON file</i></p>\
    <p>This area is called: <b>" + entity.properties.name + "</b></p><p><a target='_blank' href='" + entity.properties.link + "'>Link to the Application</a></p>";
  }
});
