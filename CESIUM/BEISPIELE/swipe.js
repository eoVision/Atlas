function globus() {
    ...
    //Bilder zur Szene hinzufügen
    layers.addImageryProvider(
      new Cesium.SingleTileImageryProvider({
        url: "Bilddateien/lightning_jan.png",
        rectangle: Cesium.Rectangle.fromDegrees(-180.0, -90.0, 180.0, 90.0), //Bilddimensionen
      })
    );
    ...
    //Bild auf die linke Seite des Swipe-Balkens legen
